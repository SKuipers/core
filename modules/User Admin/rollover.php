                        ...
                        if ($count < 1) {
                            ...
                            foreach ($students AS $student) {
                                ...
                                $row = $form->addRow();
                                    ...
                                    $column = $row->addColumn();
                                        $column->addCheckbox($count."-enrolFull-enrol")->setValue('Y')->checked(!empty($rollGroupSelect)? 'Y' : 'N')->alignLeft();
                                    $column = $row->addColumn();
                    ...
                    if ($resultReenrol->rowCount() < 1) {
                        ...
                        while ($rowReenrol = $resultReenrol->fetch()) {
                            ...
                            $row = $form->addRow();
                                ...
                                $column = $row->addColumn();
                                    $column->addCheckbox($count."-reenrol-enrol")->setValue('Y')->checked(!empty($enrolmentCheckFormGroup)? 'Y' : 'N')->alignLeft();
