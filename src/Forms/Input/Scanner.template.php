<div class="flex-grow relative inline-flex">
    ...
    <button type="button" class="-ml-px px-4 bg-gray-100 dark:bg-gray-700 inline-flex items-center border dark:border-gray-700 rounded-r-md text-base text-gray-600 dark:text-gray-300" onclick="scanner(this)">
