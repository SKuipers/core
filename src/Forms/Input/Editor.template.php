<div class="editor-<?= $mode ?> relative my-2 bg-white dark:bg-gray-800 ring-1 ring-inset ring-gray-200 dark:ring-gray-700" style="min-height: <?= $minHeight ?>px; border-radius: 10px; --tw-ring-color:rgb(208, 212, 220)">
