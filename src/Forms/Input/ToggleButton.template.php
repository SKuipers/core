...
<div
    ...
    <div class="relative flex items-center justify-center w-full text-gray-500  bg-gray-200  ring-1 ring-inset ring-gray-300 rounded-md select-none">
        ...
        <div x-init="tabMarker = $el; $el.style.left = ( ((tabSelected-1)/optionCount)*100 ) + '%';" class="absolute left-0 z-10 w-1/<?= $optionCount ?> h-9 duration-300 ease-out" x-cloak><div class="w-full h-full bg-white dark:bg-gray-700 border dark:border-gray-700 rounded-md shadow-sm"></div></div>
    </div>
