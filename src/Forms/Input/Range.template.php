<div class="flex-grow relative inline-flex justify-between items-center" x-data="{'rangeValue': '<?= $value; ?>'}">
    ...
    <output class="block w-12 p-1 ml-4 border dark:border-gray-600 rounded-md bg-gray-200 dark:bg-gray-700 dark:text-gray-100" x-html="rangeValue"><?= $value; ?></output>
</div>
