...
<textarea <?= $attributes; ?> 
    class="<?= $class; ?> w-full rounded-md border dark:border-gray-600 py-2 font-sans placeholder:text-gray-500 dark:placeholder:text-gray-400 sm:text-sm sm:leading-5
