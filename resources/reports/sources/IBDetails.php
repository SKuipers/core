...
class IBDetails extends DataSource
{
    public function getSchema()
    {
        return [
            'ibStatus'             => ['randomElement', ['Full', 'Courses', '']],
            'ibRegistrationNumber' => '',
        ];
    }
    ...
    public function getData($ids = [])
    {
        ...
        $sql = "SELECT ibProgrammeStudent.ibStatus, ibProgrammeStudent.ibRegistrationNumber
